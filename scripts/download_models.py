...
def is_enabled(env_var_name, default=True):
    """Checks if an environment variable is set to true/1/yes. Defaults to True if not set."""
...
for model in MODELS:
    # Check if this specific model is enabled via environment variables
...
print("\n🎉 All enabled HF downloads complete!")
